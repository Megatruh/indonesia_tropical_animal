...
<head>
    ...
    <style>
        ...
        .stat-card.stable { border-left: 4px solid #0d9488; }
        .stat-card.vulnerable { border-left: 4px solid #f59e0b; }
        .stat-card.endangered { border-left: 4px solid #b91c1c; }
        .stat-number {
            font-size: 2.5rem;
            font-weight: 700;
            line-height: 1;
        ...
        .stat-number.stable { color: #0d9488; }
        .stat-number.vulnerable { color: #f59e0b; }
        .stat-number.endangered { color: #b91c1c; }
        .stat-label {
            font-size: 0.875rem;
            color: var(--stone-500);
            font-weight: 500;
        ...
        .recent-species-habitat {
            font-size: 0.75rem;
            color: var(--stone-500);
        }
        .recent-species-status {
        ...
        .recent-species-status.stable {
            background: #ccfbf1;
            color: #0d9488;
        }
        .recent-species-status.vulnerable {
            background: #fef3c7;
            color: #d97706;
        }
        .recent-species-status.endangered {
            background: #fee2e2;
            color: #b91c1c;
        }
